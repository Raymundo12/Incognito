...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Incognito.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Incognito.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('Incognito.xml', function (err, result) {
            ...
            result.vinyl_sales.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price});

            console.log(JSON.stringify(result, null, "  "));

            jsToXmlFile('Incognito.xml', result, function(err){
